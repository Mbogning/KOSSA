...
class MenuLeft extends React.Component {
    ...
    render() {
        const  className='btn btn-rounded  btn-sm font-weight-bold hv-wh-50 btn-play';
        const  activeClassName='btn btn-rounded btn-sm font-weight-bold hv-wh-50 btn-outline-purple';

        return (
            <div>
                <NavLink className={constant.PLAY_URL + '/' == window.location.pathname ? activeClassName : className} to={constant.PLAY_URL + '/'}>
                    <Trans  >
                        accueil
                    </Trans>
                </NavLink>
                <NavLink className={window.location.pathname.includes('/play/artist') ? activeClassName : className} to={constant.PLAY_URL + '/artist'}>Artistes</NavLink>
                <NavLink className={window.location.pathname.includes('/play/album') ? activeClassName : className} to={constant.PLAY_URL + '/album'}>Albums</NavLink>
                <NavLink className={window.location.pathname.includes('/play/single') ? activeClassName : className} to={constant.PLAY_URL + '/single'}>Singles</NavLink>
                <NavLink className={window.location.pathname.includes('/play/top10') ? activeClassName : className} to={constant.PLAY_URL + '/top10'}>TOP 10</NavLink>
                <NavLink className={window.location.pathname.includes('/play/playlist') ? activeClassName : className} to={constant.PLAY_URL + '/playlist'}>MA PLAYLIST</NavLink>
                <NavLink className={window.location.pathname.includes('/play/jaime') ? activeClassName : className} to={constant.PLAY_URL + '/jaime'}>MES J'AIMES</NavLink>
