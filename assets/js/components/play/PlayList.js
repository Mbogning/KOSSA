    ...
    render() {
        ...
        return (
            <Base
                ...
                content={
                    <div>
                        <div className="h3-responsive font-weight-bold mt-1  mb-4">Playlist</div>
                        <div className="mb-4">
                            <div className="p-3 white  toile-content">
                                <span className="text-md-left d-inline-block ls3">
                                    <span className="font-weight-bold  fs-12 btn-sm tt mr-3 cur-pointer bnt-plyay-mus"><i className="fas fa-play fs-12 mr-2"></i>Lire tous les Audios</span>
                                    <a href="video.html" className="font-weight-bold  fs-12 btn-sm tt cur-pointer"><i className="fas fa-video fs-12 mr-2"></i> Lire tous les Vidéos</a></span>
                            </div>
                                        ...
                                        <div className="mb-2">
                                            ...
                                            <span className="float-right fs-13 ls3">
                                                <div className="mr-2 d-inline-block position-relative  " >
                                                    <i className="fas fa-heart fs-18 text-red tolltip-cnt cur-pointer" data-toggle="tooltip" data-placement="bottom" title="J'aime"></i>
                                                    ...
                                                    <i className="fa fa-trash fs-13 tt tolltip-cnt cur-pointer" data-toggle="tooltip" data-placement="bottom" title="Rétirer de la playlist"></i>
                                                    <div className="position-absolute zit p-2 tolltip ls3 d-none "></div>
                                                </div>
                                            </span>
                                        </div>
                                ...
                                <div className="d-inline-block mb-3 ml-2" >
                                    <div className="weight-mus">
                                        <div className="mb-2">
                                            ...
                                            <span className="float-right fs-13 ls3">
                                                <div className="mr-2 d-inline-block position-relative  " >
                                                    <i className="far fa-heart fs-18 tt tolltip-cnt cur-pointer" data-toggle="tooltip" data-placement="bottom" title="J'aime"></i>
                                                    <div className="position-absolute zit p-2 tolltip ls3 d-none "></div>
                                ...
                                <div className="d-inline-block mb-3 ml-2" >
                                    <div className="weight-mus">
                                        ...
                                        <div className="a-play-cont position-relative d-inline-block">
                                            ...
                                            <div className="mt-1 name-mus weight-mus"><span className="font-weight-bold name-art">Tenor </span>- <span className="">Nfian le wey le yaamoooo</span></div>
                                        </div>
                                    </div>
                                </div>
                                <div className="d-inline-block mb-3 ml-2" >
                                        ...
                                        <div className="a-play-cont position-relative d-inline-block">
                                            ...
                                            <div className="content-mus weight-mus toile-content position-relative ovh" style={{ backgroundImage: `url(${standley})` }}>
                                                ...
                                                <div className="position-absolute tp-lf0 h-100 w-100 text-center">
                                                    <div className="position-relative time-play" style={{top:'100px'}}>
                                                        <div className="text-center">
                                                            <div className="d-inline-block btn-in-img tt cur-pointer bnt-plyay-mus cl-n2 p-3 z-depth-1 mr-1" data-toggle="tooltip" data-placement="bottom" title="Play"> <i className="fa fa-play "></i></div><a href="detsingle.html" className="d-inline-block btn-in-img tt cl-n2 p-3 ml-1 z-depth-1" data-toggle="tooltip" data-placement="top" title="Détails"> <i className="fa fa-ellipsis-h "></i></a>
                                                        </div>
                                                        <div className="text-center d-inline-block mt-2 pr-2 pl-2 ls3 black cl-b3 fs-13 cur-def">03:33</div>
                                                    </div>
                                                </div>
