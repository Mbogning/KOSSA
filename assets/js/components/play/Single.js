    ...
    render() {
        ...
        return (
            <Base
                ...
                content={
                    <div>
                        <div className="h3-responsive font-weight-bold mt-1 float-md-left mb-4 mr-4">Single</div>
                        <div className="text-right mb-4">
                            <form className="t1-form form-search js-search-form position-relative" action="/search" id="global-search">
                                <input className="search-input play-search" type="text" id="search-query" placeholder="Recherchez un single" name="recherche" />
                                        ...
                                        <div className="position-absolute tp-lf0 h-100 w-100 text-center">
                                            <div className="position-relative time-play" style={{top:'100px'}}>
                                                <div className="text-center">
                                                    ...
                                                    <Link to="/single/details" className="d-inline-block btn-in-img tt cl-n2 p-3 ml-1 z-depth-1" data-toggle="tooltip" data-placement="top" title="Détails"> 
