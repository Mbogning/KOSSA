        ...
        return (
            ...
            <div className="pl-4 pt-4 pr-4 pb-3 white toile-content mb-4 position-relative">
                ...
                <div className="d-inline-block mb-2 ml-2" >
                  <div className="mb-2"><span className="badge purple pl-2 pr-2">Titre de l'album</span> <br/> <span className="font-weight-bold h3-responsive">The name of gold</span></div>
                  ...
                  <div className="pr-2">30 morceaux</div>
                </div>
                <div className="toile-content mb-3"></div>
              <div className="mb-1 mt-1 text-right p-0">
                  <span className="mr-1">
                  <Link className="font-weight-bold  fs-12 btn-sm tt" to="/artist/details">
                   <i className="fa fa-list mr-1"></i> Page de l'artiste
                   </Link>
                   </span>
                  <span className="mr-1"> <a href="" className="font-weight-bold  fs-12 btn-sm tt bnt-plyay-mus"><i className="fa fa-play mr-1"></i> Lire</a></span>
            ...
            <div className="p-4 white toile-content mt-2 text-left mb-4 ">
              <div className="row">
                <div className="col-md-12">
                    <div className="position-relative lst-sgl mb-1">
                        <div className="cl-n2 w-100 cur-def pl-3" title="Stanlay enow-Hé pére">
                            ...
                            <div className="font-weight-bold text-truncate">Hé pére</div>
                        </div>
                          <div className="position-absolute h-100 " style={{right: '0px', bottom: '0px'}}>
                            <span className="btn-play-tp-5 cur-pointer bnt-plyay-mus trs-02 bg-sgl tt toile-bl h-100 pl-3 pr-3 d-inline-flex align-items-center " data-toggle="tooltip" data-placement="bottom" title="Play">
                              <i className="fas fa-play fs-12"></i>
                            </span><span className="btn-addlst-tp-5 ret-plst cur-pointer bg-sgl tt toile-bl trs-02  h-100 pl-3 pr-3 d-inline-flex align-items-center " data-toggle="tooltip" data-placement="bottom" title="Rétirer de la playListe">
                                <i className="fas fa-trash fs-12"></i>
                              </span><a href="detsingle.html" className="btn-addlst-tp-5 tt cur-pointer bg-sgl tt toile-bl trs-02  h-100 pl-3 pr-3 d-inline-flex align-items-center " data-toggle="tooltip" data-placement="bottom" title="Détail">
                                  <i className="fas fa-ellipsis-h fs-12"></i>
                              </a>
                          </div>
                      </div>
                      <div className="position-relative lst-sgl mb-1 ">
                          <div className="cl-n2 w-100 cur-def pl-3" title="Stanlay enow-Hé pére">
                              ...
                              <div className="font-weight-bold text-truncate">05 édition</div>
                          </div>
                            <div className="position-absolute h-100 " style={{right: '0px', bottom: '0px'}}>
                              <span className="btn-play-tp-5 cur-pointer bnt-plyay-mus trs-02 bg-sgl tt toile-bl h-100 pl-3 pr-3 d-inline-flex align-items-center " data-toggle="tooltip" data-placement="bottom" title="Play">
                                <i className="fas fa-play fs-12"></i>
                              </span><span className="btn-addlst-tp-5 cur-pointer bg-sgl btn-plst tt toile-bl trs-02  h-100 pl-3 pr-3 d-inline-flex align-items-center " data-toggle="tooltip" data-placement="bottom" title="Ajouter à la playListe">
                                <i className="fas fa-plus fs-12"></i></span><div className="position-absolute p-2 z-depth-1 white p-lst d-none cont-plst animated"  alb-sng="Le single" style={{right:'0px'}}>
                                      
                                    </div><a href="detsingle.html" className="btn-addlst-tp-5 tt cur-pointer bg-sgl tt toile-bl trs-02  h-100 pl-3 pr-3 d-inline-flex align-items-center " data-toggle="tooltip" data-placement="bottom" title="Détail">
                                    <i className="fas fa-ellipsis-h fs-12"></i>
                                </a>
                            </div>
                        </div>
                      <div className="position-relative lst-sgl mb-1">
                        <div className="cl-n2 w-100 cur-def pl-3 " title="Stanlay enow-Hé pére">
                            <div className="position-absolute" style={{top:'5px', left: '10px'}}>5.</div>
                            <div className="font-weight-bold text-truncate">10 musitack </div>
                        </div>
                          <div className="position-absolute h-100 " style={{right: '0px', bottom: '0px'}}>
                            <span className="btn-play-tp-5 cur-pointer bnt-plyay-mus trs-02 bg-sgl tt toile-bl h-100 pl-3 pr-3 d-inline-flex align-items-center " data-toggle="tooltip" data-placement="bottom" title="Play">
                              <i className="fas fa-play fs-12"></i>
            ...
            <div className="p-4 white toile-content mt-2 text-left mb-4 ">
                ...
                </a><div className="d-inline-block text-center position-relative ">
