...
class BlogControllerTest extends WebTestCase
{
    ...
    {
        $postTitle = 'Blog Article Title '.mt_rand();
        ...
        $post = $client->getContainer()->get('doctrine')->getRepository(Article::class)->findOneBy([
            'title' => $postTitle,
        ]);
    ...
    {
        $newBlogArticleTitle = 'Blog Post Title '.mt_rand();
