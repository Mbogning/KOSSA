...
final class ShowcaseAdmin extends AbstractAdmin
{
    protected $baseRoutePattern = 'event/showcase';
    protected $baseRouteName = 'event_showcase';
      ...
      public function createQuery($context = 'list') {
        ...
        $query->setParameter('my_param', 'showcase');
        return $query;
    }
    ...
    public function prePersist($object) {
        ...
        $categorie = $em->getRepository('App\Entity\Event\CategorieEvent')->findOneBy(array('nom' => 'showcase'));
