...
final class ConcertAdmin extends AbstractAdmin {

    protected $baseRoutePattern = 'event/concert';
    protected $baseRouteName = 'event_concert';
      ...
      public function createQuery($context = 'list') {
        ...
        $query->setParameter('my_param', 'concert');
        return $query;
    }
    ...
    public function prePersist($object) {
        ...
        $categorie = $em->getRepository('App\Entity\Event\CategorieEvent')->findOneBy(array('nom' => 'concert'));
